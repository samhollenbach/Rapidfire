...
3. In the top left corner of unity, under the Hierarchy tab, you should see 4 scene files, one of which is labeled _Start_. 
  ...
  If you do not see the start scenes, double click the _Assets_ folder in the Unity project explorer to open it. Then click and drag the each of the four sene objects into the space under the Hierarchy tab. (These scenes have the unity logo as their picture).
